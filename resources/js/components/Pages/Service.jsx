...
function Service({service,errors,isDone}) {
    const [modalOn,setModal] = useState(false)
    // cosnt [statsus,setStatus] = useState(isDone)
  ...
  return (
    <section className="py-2 sm:py-2"> 
        <div className="container mx-auto px-4">
          ...
          <div className="lg:col-gap-12 xl:col-gap-16 mt-4 grid grid-cols-1 gap-12 lg:mt-6 lg:grid-cols-5 lg:gap-16">
            <div className="lg:col-span-3 lg:row-end-1">
              <div className="lg:flex lg:items-start">

                  <div className="max-w-xl overflow-hidden rounded-lg">
                    <img className="h-full w-full max-w-full object-cover" src="https://www.letsbuild.com/wp-content/uploads/2019/05/Depositphotos_89120612_s-2019.jpg" alt="" />
                  </div>
                
              </div>
            </div>
            <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
              <h1 className="sm: text-2xl font-bold text-gray-900 sm:text-3xl">{service.name}</h1>
              ...
              <div className="mt-4 flex flex-col items-center justify-between space-y-4
               border-t border-b py-4 sm:flex-row sm:space-y-0">
                <div className="flex ">
                    {/* <span className="font-bold ">starting from </span> */}
                  <h1 className="text-3xl font-bold">{service.price}DH</h1>
                  <span className="text-base">(negotiable)</span>
                </div>
            ...
            {modalOn && <Modal setModalFunc={setModal} service_id={service.id} errors={errors} /> }
            <div className="lg:col-span-3">
              ...
              <div className="mt-2 flow-root sm:mt-5">
              ...
              <ul className="mt-8 space-y-2">
                <li className="flex items-center text-left text-sm font-medium text-gray-600">
                  ...
                  Top 20 service provider nationally
                </li>
                <li className="flex items-center text-left text-sm font-medium text-gray-600">
                  <svg className="mr-2 block h-5 w-5 align-middle text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
Service.layout = page=> <Layout children={page} />