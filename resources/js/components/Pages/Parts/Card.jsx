...
function Card({service}) {
  return (
    ...
    <Link href={`/services/${service.id}`}>
      <img className="rounded-t-lg " src="https://www.letsbuild.com/wp-content/uploads/2019/05/Depositphotos_89120612_s-2019.jpg" alt="" />
    </Link>
    <div className="p-3">
      <a href="#">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{service.name}</h5>
      </a>
      <p className=" truncate ... mb-3 font-normal text-gray-700 dark:text-gray-400">{service.description}</p>
